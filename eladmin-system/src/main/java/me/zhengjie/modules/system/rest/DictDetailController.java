...
public class DictDetailController {
    ...
    public ResponseEntity<Object> getDictDetail(@RequestParam String dictName){
        List<DictDetail> dictDetails = dictDetailService.getDictByName(dictName);
